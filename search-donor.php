...
<head>
	<title>نظام إدارة بنك الدم للتبرع | بحث عن المتبرعين بالدم </title>
	<!-- Meta tag Keywords -->
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">قائمة المتبرعين بالدم</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
...
<div class="font-italic">فصيلة الدم<span style="color:red">*</span> </div>
...
<div class="col-lg-4 mb-4">
<div class="font-italic">الموقع </div>
...
<div class="row">
<div class="col-lg-4 mb-4">
<div><input type="submit" name="sub" class="btn btn-primary" value="ارسال" style="cursor:pointer"></div>
</div>
</div>
       <!-- /.row -->
</form>
...
{ ?>
			...
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">بحث عن المتبرعين بالدم</h3>
				<span>
...
{
echo htmlentities("لا يوجد سجلات");
