...
<head>
	<title>نظام إدارة بنك الدم للتبرع !! تم استلام الطلب</title>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">تم استلام الطلب</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="appointment py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">تم استلام الطلب</h3>
				<span>
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form" style="width:100% !important;">
					<h5 class="title-w3 text-center mb-5">.فيما يلي تفاصيل متطلب الدم</h5>
