...
echo '<script>alert("كلمة المرور الحالية الخاصة بك خاطئة")</script>';
...
<head>
	<title>نظام إدارة بنك الدم للتبرع !! تغيير كلمة المرور</title>
		...
		<div class="py-xl-5 py-lg-3">
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">أعد تعيين كلمة المرور الخاصة بك إذا لزم الأمر</h5>
					<form action="#" method="post" onsubmit="return checkpass();" name="changepassword">
						
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">كلمة السر الحالية</label>
							<input type="password" class="form-control" name="currentpassword" id="currentpassword"required='true'>
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">كلمة المرور الجديدة</label>
							<input type="password" name="newpassword"  class="form-control" required="true">
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">تأكيد كلمة المرور</label>
							<input type="password" class="form-control" name="confirmpassword" id="confirmpassword"  required='true'>
						</div>
						
						<input type="submit" value="تحديث" name="change" class="btn_apt">
					</form>
				</div>
