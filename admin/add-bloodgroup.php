...
<head>
	...
	<title>نظام إدارة بنك الدم للتبرع | المشرف إضافة مجموعة الدم</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">إضافة فصيلة الدم </h2>
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>خطأ</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">فصيلة الدم</label>
												<div class="col-sm-8">
