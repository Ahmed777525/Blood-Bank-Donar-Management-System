...
$error=".كلمة المرور الحالية غير صالحة";	
}
}
?>
...
<head>
	...
	<title>ظام إدارة بنك الدم للتبرع | المشرف تغيير كلمة المرور</title>
				...
				<div class="row">
  	        	  ...
  	        	  <?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">كلمة السر الحالية</label>
												<div class="col-sm-8">
