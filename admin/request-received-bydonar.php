						...
						<div class="panel-body">
										<form method="post" name="search" class="form-horizontal" onSubmit="return valid();">
											<div class="form-group">
												<label class="col-sm-4 control-label">البحث حسب اسم المتبرع / رقم الهاتف</label>
												<div class="col-sm-8">
...
$sdata=$_POST['searchdata'];
  ?>
  <h4 align="center">النتيجة ضد "<?php echo $sdata;?>" الكلمة الرئيسية </h4>

						<!-- Zero Configuration Table -->
						<div class="panel panel-default">
							<div class="panel-heading">معلومات الدم</div>
							<div class="panel-body">
								...
								<table border="1" class="table table-responsive">
                                    <thead>
                                         <tr>
                                         	<th>S.No</th>
                                          <th>اسم المتبرع</th>
                                          <th>رقم الجوال المتبرع</th>
                                            <th>اسم المتطلب</th>
                                            <th>رقم الجوال للمتطلب</th>
                                            <th>البريد الإلكتروني للمتطلب</th>
                                            <th>الدم مطلوب ل</th>
                                            <th>رسالة المتطلب</th>
                                            <th>تاريخ تطبيق</th>
                                        </tr>
