...
$query->execute();
    ...
    echo '<script>alert("تم تحديث ملفك الشخصي")</script>';
...
<head>
	...
	<title>نظام إدارة بنك الدم للتبرع | المشرف تغيير كلمة المرور</title>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<h2 class="page-title">الملف الشخصي للمسؤول</h2>
...
{               ?>
											...
											<div class="form-group">
												<label class="col-sm-4 control-label">اسم المشرف</label>
												<div class="col-sm-8">
											...
											<div class="hr-dashed"></div>
										<div class="form-group">
												<label class="col-sm-4 control-label">رقم الاتصال</label>
												<div class="col-sm-8">
											...
											<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-4 control-label">بريد إلكتروني</label>
												<div class="col-sm-8">
								...
								<div class="hr-dashed"></div>
											<div class="form-group">
												<label class="col-sm-4 control-label">تاريخ تسجيل المشرف</label>
												<div class="col-sm-8">
