...
if (strlen($_SESSION['bbdmsdid']==0)) {
 ...
 if(isset($_POST['update']))
  ...
  $sql="update tblblooddonars set FullName=:name,MobileNumber=:mno, Age=:age,Gender=:gender,BloodGroup=:bloodgroup,Address=:address,Message=:message  where id=:uid";
     ...
     $query->execute();
        echo '<script>alert("تم تحديث الملف الشخصي")</script>';
  }
...
<head>
    <meta charset="UTF-8">
<head>
	<title>نظام إدارة بنك الدم للتبرع !! الملف الشخصي للمتبرعين</title>
	...
	<div class="breadcrumb-agile">
		<div aria-label="breadcrumb">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">الملف الشخصي للمتبرعين</li>
			</ol>
		</div>
	</div>
	<!-- //page details -->
	...
	<div class="appointment py-5">
		<div class="py-xl-5 py-lg-3">
			<div class="w3ls-titles text-center mb-5">
				<h3 class="title">الملف الشخصي للمتبرعين</h3>
				<span>
			...
			<div class="d-flex">
				...
				<div class="contact-right-w3l appoint-form">
					<h5 class="title-w3 text-center mb-5">تفاصيل ملفك الشخصي</h5>
...
{               ?>
						<div class="form-group">
							<label for="recipient-name" class="col-form-label">الاسم الكامل</label>
							<input type="text" class="form-control" name="fullname" id="fullname" value="<?php  echo $row->FullName;?>">
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">رقم الهاتف المحمول</label>
						...
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">عنوان الايميل <span style="color:red; font-size:10px;">(لا يمكن تعديل الايميل)</span></label>
							<input type="email" name="emailid" class="form-control" value="<?php  echo $row->EmailId;?>" readonly>
						</div>
						<div class="form-group">
							<label for="recipient-phone" class="col-form-label">العمر</label>
							<input type="text" class="form-control" name="age" id="age" required="" value="<?php  echo $row->Age;?>">
						</div>
						<div class="form-group">
							<label for="datepicker" class="col-form-label">الجنس</label>
...
<option value="أنثى">أنثى</option>
						...
						<div class="form-group">
							<label for="datepicker" class="col-form-label">فصيلة الدم</label>
