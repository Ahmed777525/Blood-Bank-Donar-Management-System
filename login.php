    ...
    <section class="about py-5">
        <div class="container py-xl-5 py-lg-3">
            <div class="login px-4 mx-auto mw-100">
                <h5 class="text-center mb-4">تسجيل الدخول الآن</h5>
                <form action="#" method="post" name="login">
                    ...
                    <button type="submit" class="btn submit mb-4" name="login">تسجيل الدخول</button>
                    <!--     <p class="forgot-w3ls text-center pb-4">
                                    <a href="#" class="text-white">Forgot your password?</a>
                                </p> -->
                    <p class="account-w3ls text-center pb-4" style="color:#000">
                        ليس لديك حساب؟
                        <a href="sign-up.php">قم بإنشاء واحدة الآن</a>
                    </p>
                </form>
            </div>
